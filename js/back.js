var promo_name = '';
var price = 2490;
var linkwithout = 'https://t.me/Brainuniversity_bot?start=nopromo_program_10';
...
function send_ajax() {
  if (promo_name != '') {
    $.ajax({
      url: 'https://api.brainuniversity.ru/checkpromo/10&' + promo_name,
      type: 'POST',
      data: { res: 'res' },
      success: function (resp) {
        if (resp['res'] == 'success') {
          ...
          document.getElementById('promo_price').innerHTML =
            newprice.toFixed(2) + '&nbsp;руб';
          document.getElementById('promo_sent').onclick = function () {
            gotg(link);
          };
